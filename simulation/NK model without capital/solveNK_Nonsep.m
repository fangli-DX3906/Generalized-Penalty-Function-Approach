...
disp('**********************************************************************')
disp('NK model without physical capital, non separable utility')
...
%%
% Load Parameters
[flexp, setp] = paramset_Nonsep;

% Compute state-space representation of model
[fyn, fxn, fypn, fxpn] = model_Nonsep(flexp,setp);
...
% save './data/Nonsep/IRFs_model.mat' IRFs_model