...
plotting  = [1, 7, 2, 3, 4, 12, 8, 9, 10, 11];  % just for plotting
...
[fyn, fxn, fypn, fxpn] = model(flexp,setp);
...
% save './data/CRS/IRFs_model.mat' IRFs_model